                ...
                public void onClick(DialogInterface dialog, int which) {
                    switch (which) {
                        case 0:
                            ...
                            MeiZuActivity.show(SingleActivity.this);
                            mCalendarLayout.expand();
                            break;
                        case 1:
                            //mCalendarLayout.shrink();
                            SingleActivity.show(SingleActivity.this);
                            break;
                        case 2:
                            //mCalendarView.scrollToPre(true);
                            SimpleActivity.show(SingleActivity.this);
                            break;
                        case 3:
                            //mCalendarView.scrollToNext(true);
                            ColorfulActivity.show(SingleActivity.this);
                            break;
                        case 4:
                            //mCalendarView.scrollToCurrent(true);
                            //mCalendarView.scrollToCalendar(2018,8,30);
                            SolarActivity.show(SingleActivity.this);
                            break;
                        case 5:
                            ...
                            ProgressActivity.show(SingleActivity.this);
                            break;
                    }
                }
            };
