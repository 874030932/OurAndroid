...
public class ColorfulActivity extends BaseActivity implements
    ...
    protected void initView() {
        ...
        findViewById(R.id.iv_func).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mFuncDialog == null) {
                    mFuncDialog = new AlertDialog.Builder(ColorfulActivity.this)
                ...
                public void onClick(DialogInterface dialog, int which) {
                    switch (which) {
                        case 0:
                            ...
                            MeiZuActivity.show(ColorfulActivity.this);
                            mCalendarLayout.expand();
                            break;
                        case 1:
                            //mCalendarLayout.shrink();
                            SingleActivity.show(ColorfulActivity.this);
                            break;
                        case 2:
                            //mCalendarView.scrollToPre(true);
                            SimpleActivity.show(ColorfulActivity.this);
                            break;
                        case 3:
                            //mCalendarView.scrollToNext(true);
                            ColorfulActivity.show(ColorfulActivity.this);
                            break;
                        case 4:
                            //mCalendarView.scrollToCurrent(true);
                            //mCalendarView.scrollToCalendar(2018,8,30);
                            SolarActivity.show(ColorfulActivity.this);
                            break;
                        case 5:
                            ...
                            ProgressActivity.show(ColorfulActivity.this);
                            break;
                    }
                }
            };
