...
public class MeiZuActivity extends BaseActivity implements
    ...
    protected void initView() {
        ...
        findViewById(R.id.iv_func).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mFuncDialog == null) {
                    mFuncDialog = new AlertDialog.Builder(MeiZuActivity.this)
            ...
            new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    switch (which) {
                        case 0:
                            //mCalendarLayout.expand();
                            MeiZuActivity.show(MeiZuActivity.this);
                            mCalendarLayout.expand();
                            break;
                        case 1:
                            //mCalendarLayout.shrink();
                            SingleActivity.show(MeiZuActivity.this);
                            break;
                        case 2:
                            //mCalendarView.scrollToPre(true);
                            SimpleActivity.show(MeiZuActivity.this);
                            break;
                        case 3:
                            //mCalendarView.scrollToNext(true);
                            ColorfulActivity.show(MeiZuActivity.this);
                            break;
                        case 4:
                            //mCalendarView.scrollToCurrent(true);
                            //mCalendarView.scrollToCalendar(2018,8,30);
                            SolarActivity.show(MeiZuActivity.this);
                            break;
                        case 5:
                            ...
                            ProgressActivity.show(MeiZuActivity.this);
                            break;
                    }
                }
            };
